...
// Fetch all production records with farmer details
$stmt = $conn->query("
    SELECT 
        f.farmer_id,
...
<head>
<meta charset="UTF-8">
<title>Farmer Production & Expense Records</title>
...
<div class="main-content ml-64 p-6">
  <header class="bg-green-700 text-white py-4 px-6 rounded-lg mb-6">
    <h1 class="text-2xl font-bold">📊 Farmer Production & Expense Records</h1>
  </header>
